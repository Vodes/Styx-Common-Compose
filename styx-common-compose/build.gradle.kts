...
group = "moe.styx"
version = (System.getenv("SHAPSHOT_COMMIT") ?: "").ifBlank { "0.0.6-SNAPSHOT" }
...
publishing {
    repositories {
        maven {
            name = "Styx"
            url = if (version.toString().contains("-SNAPSHOT", true) || !System.getenv("SHAPSHOT_COMMIT").isNullOrBlank())
